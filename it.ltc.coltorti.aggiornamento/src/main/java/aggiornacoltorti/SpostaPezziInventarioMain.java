...
public class SpostaPezziInventarioMain {
	...
	private static PakiTestaDao daoTestate;
	
	public static void main(String[] args) {
		//Preparo i dati necessari
		daoTestate = new PakiTestaDao(persistenceUnit);
		PakiTesta inventario = daoTestate.trovaDaID(ID_INVENTARIO_CORR);
		int[] idDestinazioni = { 2149, 8941, 2644 };
		...
		spostatore.spostaPezzi(inventario, destinazioni);
	}
...
//		}
//		//Prendo i pakitesta in stato "ARRIVATO", "IN_LAVORAZIONE" e "LAVORATO" e li salvo in una mappa <ID, pakitesta>
